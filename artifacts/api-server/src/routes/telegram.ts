...
router.post("/telegram/webhook", async (req, res): Promise<void> => {
  try {
    ...
    const clientCtxLine = activeClientCtx
      ...
      : "";
    const sysPrompt =
      "אתה עוזר תפעולי של AgentHub, מערכת ניהול סוכני AI לעסקים.\n" +
      "ענה בעברית, בקצרה וברור.\n" +
      "תוכל לענות על שאלות על: לקוחות, סוכנים, תפוסה, טריגרים, זמינות, סטטוסים.\n" +
      "אל תמציא נתונים — אם אין לך מידע, אמור שאין לך גישה אליו כרגע." +
      clientCtxLine +
      (journalContext ? `\n\n${journalContext}` : "");
